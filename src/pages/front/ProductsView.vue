...
#front-ProductsView.text-center.q-pa-sm
  div.q-mt-lg.row.justify-center
  ...
  div.flex.q-ma-xs.justify-center.row
    .productCard.flex.justify-center.q-ma-lg.q-pt-xl.col-12.col-md-6.col-lg-3(v-for="product in filterData" :key="product._id" style="width:300px ; magin:50px 30px" )
